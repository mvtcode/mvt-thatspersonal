...
namespace dongphucdangcap.com.admin
{
    public partial class list_news : System.Web.UI.Page
    {
        ...
        private void BindGridNews()
        {
            ...
            int totalRow;
            var dtsNews = NewsImpl.Instance.GetList(pageindex - 1, _pageSize, out totalRow, int.Parse(drpCate.SelectedItem.Value));
        ...
        {
            int n;
            var dtSource = NewsCategoryImpl.Instance.GetAll(out n);
        ...
        protected void GV_Product_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            NewsImpl.Instance.Delete(newsid);
            BindGridNews();
        }
