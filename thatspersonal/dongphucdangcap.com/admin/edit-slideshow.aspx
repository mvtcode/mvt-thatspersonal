<%@ Page Title="" Language="C#" MasterPageFile="~/admin/UniAdmin.Master" AutoEventWireup="true" CodeBehind="edit-slideshow.aspx.cs" Inherits="dongphucdangcap.com.admin.edit_slideshow" %>
        ...
        <tbody>
            <tr>
                <td colspan="2" align="center" style="padding: 10px 0">
                    <asp:Label ID="LB_Messenger" runat="server" Text="Thêm mới ảnh slideshow"></asp:Label>
                </td>
            </tr>
            <tr>
