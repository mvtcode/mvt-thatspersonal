<%@ Page Title="Admin panel - Sửa thông tin cá nhân" Language="C#" MasterPageFile="~/admin/UniAdmin.Master" AutoEventWireup="true" CodeBehind="update-profile-user.aspx.cs" Inherits="dongphucdangcap.com.admin.update_profile" %>
        ...
        <tbody>
            <tr class="tblSkinRow">
                ...
                <td class="tblSkinValueColumn">
                    <asp:TextBox runat="server" ID="Fullname" Width="130px"/>
                </td>
            </tr>
            <tr class="tblSkinRow">
                <td class="tblSkinHeaderColumn">
                ...
                <td class="tblSkinValueColumn">
                    <asp:TextBox runat="server" ID="Username" Width="130px"/>
                </td>
            </tr>
            <tr class="tblSkinRow">
                <td class="tblSkinHeaderColumn">
