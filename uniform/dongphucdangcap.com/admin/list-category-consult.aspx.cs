...
{
    public partial class list_category_consult : System.Web.UI.Page
    {
        ...
        {
            var datasource = ServiceFactory.GetInstanceAdviceType().GetAll().OrderBy(a=>a.sort);
        ...
        protected void grvUser_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            if(e.CommandName=="Save")
            {
                ...
                if(t!=0)
                {
                    ...
                    if(textbox!=null)
                    {
                        ServiceFactory.GetInstanceAdviceType().UpdateSort(t, int.Parse(textbox.Text));
                        BindGrid();
                    }
                }
            }
        ...
        protected void grvUser_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            ServiceFactory.GetInstanceAdviceType().Delete(key);
                BindGrid();
        }
        ...
        protected void grvUser_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            Response.Redirect("edit-category-consult.aspx?id=" + key);
        }
    }
}
