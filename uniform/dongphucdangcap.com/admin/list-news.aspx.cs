...
namespace dongphucdangcap.com.admin
{
    public partial class list_news : System.Web.UI.Page
    {
        ...
        private void BindGridNews()
        {
            ...
            int totalRow;
            var dtsNews = ServiceFactory.GetInstanceNews().GetList(pageindex - 1, _pageSize, out totalRow,int.Parse(drpCate.SelectedItem.Value));
        ...
        {
            var dtSource = ServiceFactory.GetInstanceNewsType().GetAll();
        ...
        protected void GV_Product_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            ServiceFactory.GetInstanceNews().Delete(newsid);
            BindGridNews();
        }
