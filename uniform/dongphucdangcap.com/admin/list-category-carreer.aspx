<%@ Page Title="" Language="C#" MasterPageFile="~/admin/UniAdmin.Master" AutoEventWireup="true" CodeBehind="list-category-carreer.aspx.cs" Inherits="dongphucdangcap.com.admin.list_category_career" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="toolbar clearfix">
        <div class="toolbar-title">
            Danh sách nhóm tin tuyển dụng
        </div>
        <div class="toolbar-action">
            <ul>
                <li>
                    <a href="edit-category-career.aspx">
