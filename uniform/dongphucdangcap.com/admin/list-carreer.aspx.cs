...
{
    public partial class list_career : System.Web.UI.Page
    {
        ...
        private void BindGridNews()
        {
            ...
            int totalRow;
            var dtsNews = ServiceFactory.GetInstanceCarreer().GetList(pageindex - 1, _pageSize, out totalRow, int.Parse(drpCate.SelectedItem.Value));
        ...
        {
            var dtSource = ServiceFactory.GetInstanceCarreerType().GetAll();
        ...
        {
            Response.Redirect("list-carreer.aspx?page=" + drpPageNum.SelectedItem.Value);
        }
        ...
        protected void GV_Product_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            ServiceFactory.GetInstanceCarreer().Delete(newsid);
            BindGridNews();
        }
        ...
        protected void GV_Product_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            Response.Redirect("edit-carreer.aspx?id=" + newsid);
        }
    }
}
