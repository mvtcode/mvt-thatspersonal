<%@ Page Title="" Language="C#" MasterPageFile="~/admin/UniAdmin.Master" AutoEventWireup="true" CodeBehind="edit-consult.aspx.cs" Inherits="dongphucdangcap.com.admin.edit_consult" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="toolbar clearfix">
        <div class="toolbar-title">
            <% if (IsEdit)
               { %>Cập nhật tin bảng giá<% }
               else
               {
                %>
                   Thêm mới bản tin bảng giá
                <%
               } %>
