<%@ Page Title="" Language="C#" MasterPageFile="~/admin/UniAdmin.Master" AutoEventWireup="true" CodeBehind="list-price.aspx.cs" Inherits="dongphucdangcap.com.admin.list_price" %>
    ...
    <asp:GridView ID="GridNews" DataKeyNames="id" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Hình ảnh">
                <ItemTemplate>
                    <img style="width: 100px" src='/images/<%# Eval("image").Equals("")?"no_pic.png":("prices/"+(int)Eval("id")/200+"/"+Eval("id")+"/"+Eval("image")) %>'/>
                </ItemTemplate>
                <ItemStyle Width="10%" />
            </asp:TemplateField>
