<%@ Page Title="" Language="C#" MasterPageFile="~/admin/UniAdmin.Master" AutoEventWireup="true" CodeBehind="edit-category-price.aspx.cs" Inherits="dongphucdangcap.com.admin.edit_category_price" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="toolbar clearfix">
        <div class="toolbar-title">
            <% if (IsEdit)
               { %>Cập nhật nhóm tin bảng giá<% }
               else
               {
                %>
                   Thêm mới nhóm tin bảng giá
                <%
               } %>
