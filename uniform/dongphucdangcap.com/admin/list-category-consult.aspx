<%@ Page Title="" Language="C#" MasterPageFile="~/admin/UniAdmin.Master" AutoEventWireup="true" CodeBehind="list-category-consult.aspx.cs" Inherits="dongphucdangcap.com.admin.list_category_consult" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="toolbar clearfix">
        <div class="toolbar-title">
            Danh sách nhóm tin tư vấn
        </div>
        <div class="toolbar-action">
            <ul>
                <li>
                    <a href="edit-category-consult.aspx">
