<%@ Page Title="" Language="C#" MasterPageFile="~/admin/UniAdmin.Master" AutoEventWireup="true" CodeBehind="edit-about.aspx.cs" Inherits="dongphucdangcap.com.admin.edit_about" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="toolbar clearfix">
        <div class="toolbar-title">
            <% if (IsEdit)
               { %>Cập nhật tin giới thiệu<% }
               else
               {
                %>
                   Thêm mới tin giới thiệu
                <%
               } %>
