...
{
    public partial class list_about : System.Web.UI.Page
    {
        ...
        private void BindGridNews()
        {
            ...
            int totalRow;
            var dtsNews = ServiceFactory.GetInstanceIntroduction().GetList(pageindex - 1, _pageSize, out totalRow, int.Parse(drpCate.SelectedItem.Value));
        ...
        {
            var dtSource = ServiceFactory.GetInstanceIntroductionType().GetAll();
        ...
        {
            Response.Redirect("list-about.aspx?page=" + drpPageNum.SelectedItem.Value);
        }
        ...
        protected void GV_Product_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            ServiceFactory.GetInstanceIntroduction().Delete(newsid);
            BindGridNews();
        }
        ...
        protected void GV_Product_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            Response.Redirect("edit-about.aspx?id=" + newsid);
        }
    }
}
