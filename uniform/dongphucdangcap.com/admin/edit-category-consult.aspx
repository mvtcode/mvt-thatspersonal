<%@ Page Title="" Language="C#" MasterPageFile="~/admin/UniAdmin.Master" AutoEventWireup="true" CodeBehind="edit-category-consult.aspx.cs" Inherits="dongphucdangcap.com.admin.edit_category_consult" %>
   ...
   <div class="navi-action">
    ...
    <div class="toolbar clearfix">
        <div class="toolbar-title">
            <% if (IsEdit)
               { %>Cập nhật nhóm tin tư vấn<% }
               else
               {
                %>
                   Thêm mới nhóm tin tư vấn
                <%
               } %>
