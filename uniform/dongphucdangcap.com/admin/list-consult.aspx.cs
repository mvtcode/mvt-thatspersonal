...
{
    public partial class list_consult : System.Web.UI.Page
    {
        ...
        private void BindGridNews()
        {
            ...
            int totalRow;
            var dtsNews = ServiceFactory.GetInstanceAdvice().GetList(pageindex - 1, _pageSize, out totalRow, int.Parse(drpCate.SelectedItem.Value));
        ...
        {
            var dtSource = ServiceFactory.GetInstanceAdviceType().GetAll();
        ...
        {
            Response.Redirect("list-consult.aspx?page=" + drpPageNum.SelectedItem.Value);
        }
        ...
        protected void GV_Product_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            ServiceFactory.GetInstanceAdvice().Delete(newsid);
            BindGridNews();
        }
        ...
        protected void GV_Product_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            Response.Redirect("edit-consult.aspx?id=" + newsid);
        }
    }
}
