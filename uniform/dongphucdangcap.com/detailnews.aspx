<%@ Page Title="" Language="C#" MasterPageFile="~/UniMaster.Master" AutoEventWireup="true" CodeBehind="detailnews.aspx.cs" Inherits="dongphucdangcap.com.detailnews" %>
            ...
            <div class="newsmain">
                <div class="newsborder">
                    <div class="scroll-pane">
                        ...
                        <div class="fb-comments" data-href="<%= Request.RawUrl %>" data-num-posts="5" data-width="660"></div>
                    </div>
                </div>
            </div>
        </div>
