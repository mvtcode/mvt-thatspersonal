...
namespace dongphucdangcap.com
{
    public partial class about : System.Web.UI.Page
    {
        ...
        {
            var listNav = ServiceFactory.GetInstanceIntroductionType().GetAll();
        ...
        private string BuildList()
        {
            ...
            int totalRow;
            var lstPrice = ServiceFactory.GetInstanceIntroduction().GetList(pageIndex - 1, Config.RecordPerPage, out totalRow, cateId);
            ...
            foreach (var info in lstPrice)
            {
                ...
                if (string.IsNullOrEmpty(info.image))
                    ...
                    sb.Append("images/about/" + info.id / 200 + "/" + info.id + "/168.109." + info.image);
